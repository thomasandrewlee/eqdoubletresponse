...
plot!(hptg,1 ./TXFRF[2:end],log10.(TXFRD_smth[2:end])-TXFRstd[2:end],lc=:lightgray,ls=:dash,label="1-sigma",lw=1)
plot!(hptg,1 ./TXFRF[2:end],log10.(TXFRD_smth[2:end])+TXFRstd[2:end],lc=:lightgray,ls=:dash,label="",lw=1)
...
plot!(hptgl,log10.(1 ./TXFRF[2:end]),log10.(TXFRD_smth[2:end]).-TXFRstd[2:end],lc=:lightgray,ls=:dash,label="1-sigma",lw=1)
plot!(hptgl,log10.(1 ./TXFRF[2:end]),log10.(TXFRD_smth[2:end]).+TXFRstd[2:end],lc=:lightgray,ls=:dash,label="",lw=1)
